# -*- coding: utf-8 -*-
"""NCS-Render_Shapes.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hzw2mICnpBPxOYY7-xG-f_EAxB3IYGsQ
"""
...
def render_shape(
    ...
    for i in range(images.shape[0]):
        ...
        if (shape_type is "circle"):
          img = circle_new(int(diameter), p=shape_p, device=device)
        elif (shape_type is "square"):
          img = square_new(int(diameter), p=shape_p, device=device)
        elif (shape_type is "triangle"):
          img = triangle_new(int(diameter), p=shape_p, device=device)
